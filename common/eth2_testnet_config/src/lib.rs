...
pub const HARDCODED_TESTNET: Option<&str> = Some("prysm-onyx");

pub const HARDCODED_YAML_CONFIG: &[u8] = include_bytes!("../prysm-onyx/config.yaml");
pub const HARDCODED_DEPLOY_BLOCK: &[u8] = include_bytes!("../prysm-onyx/deploy_block.txt");
pub const HARDCODED_DEPOSIT_CONTRACT: &[u8] = include_bytes!("../prysm-onyx/deposit_contract.txt");
pub const HARDCODED_GENESIS_STATE: &[u8] = include_bytes!("../prysm-onyx/genesis.ssz");
pub const HARDCODED_BOOT_ENR: &[u8] = include_bytes!("../prysm-onyx/boot_enr.yaml");
